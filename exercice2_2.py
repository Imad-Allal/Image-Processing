...
img_smooth_3 = ls.smoothing(image_gauss, 3)
psnr1 = cv.PSNR(img, img_smooth_3)
psnr_values.append(psnr1)

img_smooth_5 = ls.smoothing(image_gauss, 5)
psnr2 = cv.PSNR(img, img_smooth_5)
psnr_values.append(psnr2)

img_smooth_7 = ls.smoothing(image_gauss, 7)
psnr3 = cv.PSNR(img, img_smooth_7)
psnr_values.append(psnr3)

Hori = np.concatenate((image, image_gauss, img_smooth_3, img_smooth_5, img_smooth_7), axis=1)
